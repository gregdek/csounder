...
; http://www.csounds.com/toots/index.html#toot04
;
; Toot 4: Chorusing
;
; Some very interesting new bits here:
;   * The ampdb opcode for converting decibels to linear amplitude;
;   * The cpspch opcode to allow us to use "octave.pitch" notation;
;   * The addition of several signals together into a1.
