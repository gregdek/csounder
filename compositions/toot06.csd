...
; http://www.csounds.com/toots/index.html#toot06
;
; Toot 6: GENs
;
; I am starting to gain an appreciation for the way that these are formatted,
; and the way that good commenting can make this stuff way easier to handle.
;
; Notable here:
; * Multiple waveforms for the same instrument, that can be parameterized. Useful.
; * Lots of knobs on an instrument == super powerful.
; * This one instrument could be played with a lot, and make a lot of cool sounds.
; * Starting to understand the power of csound more fully.
